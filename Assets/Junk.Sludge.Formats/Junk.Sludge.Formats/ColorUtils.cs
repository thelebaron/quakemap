...
namespace Junk.Sludge.Formats
{
    ...
    public static class ColorUtils
    {
        ...
        public static Color Vary(Color color, int by = 10)
        {
            by = Rand.Next(-by, by);
            return Color.FromArgb(color.A, System.Math.Min(255, System.Math.Max(0, color.R + by)), System.Math.Min(255, System.Math.Max(0, color.G + by)), System.Math.Min(255, System.Math.Max(0, color.B + by)));
        }
        ...
        public static Color Darken(Color color, int by = 20)
        {
            return Color.FromArgb(color.A, System.Math.Max(0, color.R - by), System.Math.Max(0, color.G - by), System.Math.Max(0, color.B - by));
        }
        ...
        public static Color Lighten(Color color, int by = 20)
        {
            return Color.FromArgb(color.A, System.Math.Min(255, color.R + by), System.Math.Min(255, color.G + by), System.Math.Min(255, color.B + by));
        }
        ...
        public static Color GetIdealForegroundColour(Color color)
        {
