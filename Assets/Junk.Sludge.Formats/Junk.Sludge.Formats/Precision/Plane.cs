...
namespace Sledge.Formats.Precision
{
    ...
    public struct Plane
    {
        ...
        public float3? GetIntersectionPoint(Vector3 start, Vector3 end, bool ignoreDirection = false, bool ignoreSegment = false)
        {
        ...
        public static float3? Intersect(Plane p1, Plane p2, Plane p3)
        {
