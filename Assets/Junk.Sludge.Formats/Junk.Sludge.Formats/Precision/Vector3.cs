...
namespace Junk.Sludge.Formats.Precision
{
    ...
    public struct Vector3
    {
        ...
        {
            return new Vector3(System.Math.Round(X, num), System.Math.Round(Y, num), System.Math.Round(Z, num));
        }
        ...
        {
            return (double) System.Math.Sqrt((double) LengthSquared());
        }
        ...
        public System.Numerics.Vector3 ToStandardVector3()
        {
            ...
            return new System.Numerics.Vector3((float) System.Math.Round(X, rounding), (float) System.Math.Round(Y, rounding), (float) System.Math.Round(Z, rounding));
        }
    }
}