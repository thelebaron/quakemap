...
namespace Junk.Sludge.Formats.Geometric
{
    ...
    public class Polyhedron
    {
        ...
        public float3 Origin => Polygons.Aggregate(float3.zero, (x, y) => x + y.Origin) / Polygons.Count;
        ...
        public Polyhedron(IEnumerable<Plane> planes)
        {
            ...
            var origin = polygons.Aggregate(float3.zero, (x, y) => x + y.Origin) / polygons.Count;
        ...
        public bool Split(Plane plane, out Polyhedron back, out Polyhedron front)
        {
            ...
            var frontPlanes = new List<Plane> { new Plane(-plane.Normal, -plane.Distance) };
