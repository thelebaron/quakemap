...
namespace Junk.Math
{
    ...
    public class Polyhedrond
    {
        ...
        public double3 Origin => Polygons.Aggregate(double3.zero, (x, y) => x + y.Origin) / Polygons.Count;
        ...
        public Polyhedrond(IEnumerable<Planed> planes)
        {
            ...
            var origin = polygons.Aggregate(double3.zero, (x, y) => x + y.Origin) / polygons.Count;
        ...
        public bool Split(Planed plane, out Polyhedrond back, out Polyhedrond front)
        {
            ...
            var frontPlanes = new List<Planed> { new Planed(-plane.Normal, -plane.Distance) };
