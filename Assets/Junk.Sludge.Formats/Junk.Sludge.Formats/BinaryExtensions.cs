...
namespace Junk.Sludge.Formats
{
    ...
    public static class BinaryExtensions
    {
        ...
        public static float3[] ReadVector3Array(this BinaryReader br, int num)
        {
            var arr                              = new float3[num];
            for (var i = 0; i < num; i++) arr[i] = br.ReadVector3();
            return arr;
        }

        public static float3 ReadVector3(this BinaryReader br)
        {
            return new float3(
                br.ReadSingle(),
                br.ReadSingle(),
        ...
        public static void WriteVector3(this BinaryWriter bw, float3 c)
        {
            bw.Write(c.x);
            bw.Write(c.y);
            bw.Write(c.z);
